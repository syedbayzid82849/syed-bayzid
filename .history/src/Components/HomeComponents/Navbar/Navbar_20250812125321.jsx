...
const Navbar = () => {
        ...
        <>
            <li>
                <NavLink to="#home">
                    <a
                        href="#home"
                        className="block px-4 py-2 text-cyan-100 font-bold hover:bg-gray-700 rounded"
                    >
                        Home
                    </a>
                </NavLink>
    ...
    return (
        <nav className="fixed top-0 left-0 w-full bg-transparent shadow-sm z-50 shadow-sm border-b-2 border-blue-500">
