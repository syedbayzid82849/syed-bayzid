...
const Navbar = () => {
    ...
    const links = (
        <>
            <li>
                <a
                    href="#home"
                    className="block px-4 py-2 text-white font-bold hover:bg-gray-200 rounded"
                >
                    Home
                </a>
            </li>
    ...
    return (
        <nav className="fixed top-0 left-0 w-full bg-transparent shadow-sm z-50">
            ...
            {/* Mobile Dropdown */}
            {isOpen && (
                <div className="lg:hidden  shadow-md border-t border-gray-200 bg-gray-800 w-2/3 flex justify-end ite">
