...
const Navbar = () => {
    ...
    return (
        <nav className="fixed top-0 left-0 w-full shadow-sm z-50  backdrop-blur-md ">
            ...
            {/* Mobile Dropdown */}
            {isOpen && (
                <div className="lg:hidden  shadow-md border-t border-gray-200 bg-gray-800 w-2/3 rounded-xl">
