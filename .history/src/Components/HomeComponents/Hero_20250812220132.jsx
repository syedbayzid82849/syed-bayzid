...
const Hero = () => {
    ...
    const socialLinks = [
        ...
        {
            href: 'https://www.facebook.com/syed.bayzidhusain/',
            icon: Facebook,
            label: 'Facebook',
        }
    ];
    ...
    return (
        <section id="home" className="min-h-screen py-10 pt-10 sm:mt-6 flex items-center justify-center relative overflow-hidden">
            ...
            <div className="container mx-auto px-6 relative z-10">
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    <motion.div
                        ...
                        className="space-y-8 text-center sm:text-center md:text-center lg:text-left flex flex-col items-center lg:items-start"
                    >
                        {/* Greeting */}
                        <motion.div
                        ...
                        >
                            <button
                                ...
                                className="group relative border-2 border-cyan-400 text-cyan-400 hover:bg-cyan-400/10 px-8 py-3 text-lg font-semibold rounded-lg flex items-center justify-center bg-gradient-hero hover:shadow-glow transition-all duration-300"
                            >
                                <span>
                        ...
                        <motion.div
                            ...
                            className="flex space-x-6 mt-2 justify-center lg:justify-start"
                        >
