...
const Hero = () => {
    ...
    return (
        <section id="home" className="min-h-screen py-10  flex items-center justify-center relative overflow-hidden bg-background text-foreground">
                    ...
                    >
                        ...
                        >
                            ...
                            <h1 className="text-5xl lg:text-7xl font-bold">
                                <span className="text-gray-800">Syed </span>
