        ...
        <section id='home' className=" text-gray-900 dark:text-white transition-colors duration-300">
            ...
            <div className="container flex flex-col justify-center mx-auto  sm:py-12 lg:flex-row  lg:justify-between items-center">
                ...
                <div className="  px-5 ">
                    ...
                    <div>
                        <button onClick={()=> handleGetResumeBtn()} type="button" className="px-8 py-3 font-semibold border rounded dark:border-gray-800 dark:text-gray-800 curserpointer">Get Resume</button>
