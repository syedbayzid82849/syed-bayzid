...
const Hero = () => {
    ...
    return (
        <section
            id="home"
            className="text-gray-900 dark:text-white transition-colors duration-300 h-screen flex items-center justify-center bg-gradient-to-r from-blue-50 to-blue-100 dark:from-gray-800 dark:to-gray-900 "
        >
