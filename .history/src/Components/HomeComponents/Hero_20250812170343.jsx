                    ...
                    >
                        ...
                        >
                            <button
                                ...
                                className="group wf relative border-2 border-cyan-400 text-cyan-400 hover:bg-cyan-400/10 px-8 py-3 text-lg font-semibold rounded-lg flex items-center justify-center bg-gradient-hero hover:shadow-glow transition-all duration-300"
                            >
                                <span>
