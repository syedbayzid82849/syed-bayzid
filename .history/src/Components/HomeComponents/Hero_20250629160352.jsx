            ...
            <div className="container flex flex-col justify-center mx-auto  sm:py-12 lg:flex-row  lg:justify-between items-center">
                ...
                <div className="  px-5 ">
                    ...
                    <div>
                        ...
                        <button type="button" className="px-8 py-3 font-semibold border rounded dark:border-gray-800 dark:text-gray-800"><a href="https://www.linkedin.com/in/syed-bayzid-b91343329/"></a></button>
                    </div>
