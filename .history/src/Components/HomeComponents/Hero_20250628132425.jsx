...
const Hero = () => {
    ...
    const content = 
    <nav className='z-10 lg:hidden fixed top-0 left-0 bottom-0 pt-[50px] bg-[#1c1331] backdrop-filter backdrop-blur-lg bg-opacity-30 w-[300px] flex gap-[20px] flex-col items-center transition ease-out duration-700'>
