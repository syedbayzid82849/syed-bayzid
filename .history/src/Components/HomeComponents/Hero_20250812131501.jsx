...
const Hero = () => {
    ...
    return (
        <section id="home" className="min-h-screen border py-10 flex items-center justify-center relative overflow-hidden">
            ...
            >
                ...
                >
                    <motion.div
                        animate={{ y: [0, 12, 0] }}
                        transition={{ duration: 2, repeat: Infinity }}
                        className="w-1 h-2 bg-amber-2      {/* Scroll indicator */}
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        transition={{ delay: 2.5, duration: 0.6 }}
      ...
      </motion.div>00 rounded-full mt-2"
                    />
                </motion.div>
            </motion.div>
        </section >
