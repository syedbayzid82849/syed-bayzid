...
const ContactInfo = () => {
    return (
        <section id='contact' className="py-10 px-5 mt-16 text-slate-100 transition-colors duration-300">
            <h1 className="text-4xl font-bold text-center mb-6 text-primary">Contact</h1>
