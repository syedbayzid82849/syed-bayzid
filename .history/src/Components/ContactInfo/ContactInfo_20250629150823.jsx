        ...
        <section className="py-6 ">
            ...
            <div className="grid max-w-6xl grid-cols-1 px-6 mx-auto lg:px-8 md:grid-cols-2 md:divide-x">
                ...
                <form noValidate="" className="flex flex-col py-6 space-y-6 md:py-0 md:px-6">
                    ...
                    <button type="button" className="bg-blue-500 self-center px-8 py-3 text-lg rounded focus:ring hover:ring focus:ring-opacity-75 dark:bg-default-600 dark:text-gray-50 focus:dark:ring-default-600 hover:dark:ring-default-600">Submit</button>
                </form>
            </div>
        </section>
    );
