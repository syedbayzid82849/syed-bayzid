                ...
                <form noValidate className="flex flex-col py-6 space-y-6 md:px-6">
                    <label className="block">
                        ...
                        <input
                            ...
                            className="w-full px-4 py-2 rounded-md shadow-sm text-black dark:text-white focus:ring focus:ring-blue-300"
                        />
                    </label>
                    <label className="block">
                    ...
                    <button
                        type="submit"
                        className="self-start px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-md transition duration-300"
                    >
                        Submit
                    </button>
                </form>
