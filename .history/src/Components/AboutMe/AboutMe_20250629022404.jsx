...
const AboutMe = () => {
    return (
        <section id="about" className="border rounded-xl border-gray-400 py-16  md:px-5 ">
            ...
            <div className=" mx-auto text-lg text-neutral-content space-y-6">
                <p>
                    Hello! I'm <span class="font-semibold text-secondary">Syed Bayzid</span>, a passionate and detail-oriented <strong>MERN Stack & Frontend Developer</strong>. I love building fast, responsive, and user-friendly web applications using the latest technologies.
                </p>
                <p>
