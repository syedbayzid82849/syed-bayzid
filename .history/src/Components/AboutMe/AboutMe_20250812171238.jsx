...
const AboutMe = () => {
    return (
        <section id="about" className="px-5 py-10 mx-auto mt-16 border">
            ...
            <div className=" mx-auto text-lg text-neutral-content space-y-6 ">
                <p>
                    Hello! I'm <span class="font-semibold text-secondary animate-bounce">Syed Bayzid</span>, a passionate and detail-oriented <strong>MERN Stack Developer</strong>. I love building fast, responsive, and user-friendly web applications using the latest technologies.
                </p>
                <p>
