...
const AboutMe = () => {
    return (
        <section id="about" className="min-h-screen border py-10 flex items-center justify-center relative overflow-hidden">
            <h2 className="text-4xl font-bold text-center mb-8 text-primary">About Me</h2>
            <div className=" mx-auto text-lg text-neutral-content space-y-6 text-center">
                <p>
