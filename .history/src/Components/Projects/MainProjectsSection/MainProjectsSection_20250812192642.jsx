...
import MainProjectsSectionData from "../MainProjectsSection.json"; // Adjust path if needed

const MainProjectsSection = () => {
    const [MainProjectsSection, setMainProjectsSection] = useState([]);
    const [selectedProject, setSelectedProject] = useState(null);

    useEffect(() => {
        setMainProjectsSection(MainProjectsSectionData);
    }, []);

    return (
        <section id="MainProjectsSection" className="py-10 bg-gray-50 dark:bg-gray-900">
            <div className="container mx-auto px-4">
                <h2 className="text-3xl font-bold text-center mb-8 text-gray-900 dark:text-white">
                    My MainProjectsSection
                </h2>

                <div className="flex flex-col gap-6">
                    {MainProjectsSection.map((project) => (
                        <div
                            key={project.id}
