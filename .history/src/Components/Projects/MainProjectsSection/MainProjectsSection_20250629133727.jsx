                ...
                <div className=' max-w-full p-3 rounded-md shadow-md bg-gray-900 grid md:grid-cols-3 gap-3'>
                    ...
                    <div className='mt-6 mb-2 md:border-l-2 lg:border-gray-400 md:pl-2 '>
                        ...
                        <div className=' flex gap-5 py-3'>
                            ...
                            <button className='px-4  bg-white/10  border border-white/20 backdrop-blur-md rounded-full shadow-sm hover:bg-white/20 transition duration-200'>react icone</button>
                        </div>
                    </div>
