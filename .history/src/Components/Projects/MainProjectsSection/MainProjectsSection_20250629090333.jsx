            ...
            <div className='border py-10 px-5'>
                <div className=' max-w-full p-3 rounded-md shadow-md bg-gray-900 grid lg:grid-cols-3 gap-3'>
                    ...
                    <div className=' flex justify-around'>
                        <button type="button" className="h-4 px-4 py-2 font-semibold border rounded dark:border-gray-800 dark:text-gray-800 hover:transition-3 transition delay-100 duration-300 ease-in-out hover:bg-white  bg-indigo-500">Live show</button>
