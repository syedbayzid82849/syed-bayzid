        ...
        <section className="py-10 px-5 max-w-6xl mx-auto">
                ...
                <div className=' max-w-full p-3 rounded-md shadow-md bg-gray-900 grid md:grid-cols-3 gap-3'>
                    ...
                    <div className='mt-6 mb-2 md:border-l-2 lg:border-gray-400 md:pl-2 '>
                        ...
                        <div className=' flex gap-5 py-3'>
                            ...
                            <button className='px-4  bg-white/10  border border-white/20 backdrop-blur-md rounded-full shadow-sm hover:bg-white/20 transition duration-200'>react icon</button>
            ...
            <div className=' py-3 md:px-5'>
                <div className=' max-w-full p-3 rounded-md shadow-md bg-gray-900 grid md:grid-cols-3 gap-3'>
                    ...
                    <div className='mt-6 mb-2 md:border-l-2 lg:border-gray-400 md:pl-2 '>
                        <h3 className='text-2xl font-semibold tracking-wide'>🎯 HobbyHub</h3>
                        <p>
                    ...
                    <div className=' flex flex-row flex-wrap gap-2 justify-center items-center  md:flex-col md:gap-3'>
                        <button type="button" className="h-10 px-2 py-2 font-semibold border rounded dark:border-gray-800 dark:text-gray-800 hover:transition-3 transition delay-100 duration-300 ease-in-out hover:bg-white  bg-indigo-500"><a href="https://hobby-hub-01.netlify.app/">Live Show</a></button>
                        <button type="button" className="h-10 px-2 py-2  font-semibold border rounded dark:border-gray-800 dark:text-gray-800 hover:transition-3 transition delay-100 duration-300 ease-in-out hover:bg-white  bg-indigo-500"><a href="https://github.com/syedbayzid82849/HobbyHub-project?tab=readme-ov-file">github</a></button>
                        <button type="button" className="h-10 px-2 py-2  font-semibold border rounded dark:border-gray-800 dark:text-gray-800 hover:transition-3 transition delay-100 duration-300 ease-in-out hover:bg-white  bg-indigo-500"><a href="https://github.com/syedbayzid82849/HobbyHub-project/blob/main/README.md">details</a></button>
                    </div>
                </div>
            </div>
            {/* card 3  */}
            <div className=' py-3 md:px-5'>
                <div className=' max-w-full p-3 rounded-md shadow-md bg-gray-900 grid md:grid-cols-3 gap-3'>
                    ...
                    <div className=' flex flex-row flex-wrap gap-2 justify-center items-center  md:flex-col md:gap-3'>
                        <button type="button" className="h-10 px-2 py-2 font-semibold border rounded dark:border-gray-800 dark:text-gray-800 hover:transition-3 transition delay-100 duration-300 ease-in-out hover:bg-white  bg-indigo-500"><a href="">Live</a></button>
                        <button type="button" className="h-10 px-2 py-2  font-semibold border rounded dark:border-gray-800 dark:text-gray-800 hover:transition-3 transition delay-100 duration-300 ease-in-out hover:bg-white  bg-indigo-500">github</button>
                        <button type="button" className="h-10 px-2 py-2  font-semibold border rounded dark:border-gray-800 dark:text-gray-800 hover:transition-3 transition delay-100 duration-300 ease-in-out hover:bg-white  bg-indigo-500">details</button>                    </div>
                </div>
            </div>
