            ...
            <div className='border max-w-full p-3 rounded-md shadow-md dark:bg-gray-50 dark:text-gray-900'>
                ...
                <div className='mt-6 mb-2'>
                    ...
                    <div className=' flex gap-5'>
                        <button className='px-4 py-2 bg-white/10 text-b border border-white/20 backdrop-blur-md rounded-full shadow-sm hover:bg-white/20 transition duration-200'>react</button>
                        <button>vite</button>
