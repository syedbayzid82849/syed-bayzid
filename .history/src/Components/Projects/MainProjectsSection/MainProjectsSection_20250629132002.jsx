            ...
            <div className=' py-3 md:px-5'>
                <div className=' max-w-full p-3 rounded-md shadow-md bg-gray-900 grid md:grid-cols-3 gap-3'>
                    ...
                    <div className='mt-6 mb-2 md:border-l-2 lg:border-gray-400 md:pl-2 '>
                        ...
                        <p>
                            Academix-Hub is a sleek course management platform enabling students to explore and enroll in courses, while instructors manage content securely via a role-based dashboard. It features secure auth, smooth UI, and interactive design.
                        </p>
