        ...
        <section className="py-10 px-5 max-w-6xl mx-auto">
            ...
            <div className='border max-w-full p-3 rounded-md shadow-md bg-gray-900'>
                ...
                <div className=' flex justify-around'>
                    <button type="button" className="px-4 py-1 font-semibold border rounded dark:border-gray-800 dark:text-gray-800 hover:transition-3 transition delay-100 duration-300 ease-in-out hover:bg-white hover:textb bg-indigo-500">Live show</button>
