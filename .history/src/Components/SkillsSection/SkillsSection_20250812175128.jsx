...
const SkillsStatic = () => {
    return (
        <section className="py-10 px-5 mt-16 border rounded-lg max-w-5xl mx-auto ">
            ...
            {/* Frontend */}
            <div className="mb-10">
                <h3 className="text-xl font-semibold mb-6 mt- ">Frontend : </h3>
            ...
            {/* Backend */}
            <div className="mb-10">
                <h3 className="text-xl font-semibold mb-6 mt-">Backend : </h3>
            ...
            {/* Tools */}
            <div>
                <h3 className="text-xl font-semibold mb-6 mt-">Tools & Design : </h3>
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 justify-items-center">
