...
const SkillsStatic = () => {
    return (
        <section className="py-10 px-5 mt-16 border rounded-lg max-w-5xl mx-auto ">
            <h2 className="text-3xl font-bold mb-12 text-primary text-center ">Skills</h2>

            {/* Frontend */}
            <div className="mb-10">
                <h3 className="text-xl font-semibold mb-6 mt-10 ">Frontend : </h3>
            ...
            {/* Backend */}
            <div className="mb-10">
                <h3 className="text-xl font-semibold mb-6 mt-10">Backend : </h3>
            ...
            {/* Tools */}
            <div>
                <h3 className="text-xl font-semibold mb-6 mt-10">Tools & Design : </h3>
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 justify-items-center">
