                    ...
                    <div key={category._id} className="bg-gray-900 backdrop-blur-md px-6 sm:px-10 py-8 sm:py-6 mb-6 w-full sm:w[48%] rounded-2xl border border-white shadow-[0_0_20px_1px_rgba(130, 69, 236, 0.3)]">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                            ...
                            >
                                ...
                                <div key={skill._id} className="flex items-center justify-center space-x-2 bg-transparent bggra border-2 border-gray-700 rounded-3xl py-2 px-2 hover:bg-gray-800 transition-colors duration-300">
