    ...
    return (
        <section id="skills" className="px-5 py-10 mx-auto mt-16 text-center">
            <div className="border">
                <h1 className="text-primary text-4xl font-bold text-center mb-8 text-primary"Skills And Tools</h1>
...
//                     <ellipse rx="50" ry="18" cx="64" cy="64" fill="none" stroke="#61DAFB" strokeWidth="4" />
//                     <ellipse rx="18" ry="50" cx="64" cy="64" fill="none" stroke="#61DAFB" strokeWidth="4" />
//                     <ellipse rx="35" ry="12" cx="64" cy="64" fill="none" stroke="#61DAFB" strokeWidth="4" transform="rotate(60 64 64)" />
//                 </g>
//             </svg>
//             <div>React</div>
//         </div>
...
//                     <text x="64" y="76" fill="#fff" fontSize="22" fontFamily="Arial" textAnchor="middle" dominantBaseline="middle">Ex</text>
//                 </g>
//             </svg>
//             <div>Express</div>
//         </div>
...
//                     <text x="64" y="76" fill="#fff" fontSize="22" fontFamily="Arial" textAnchor="middle" dominantBaseline="middle">JWT</text>
//                 </g>
//             </svg>
//             <div>JWT</div>
//         </div>
