    ...
    return (
        ...
        >
            ...
            <div className=" flex flex-wrap  gap-6 mt-8">
                ...
                {skills?.map((category) => (
                    <div key={category._id} className="bg-gray-900 backdrop-blur-md px-6 sm:px-10 py-8 sm:py-6 mb-6 w-full smw[48%] rounded-2xl border border-white shadow-[0_0_20px_1px_rgba(130, 69, 236, ">
